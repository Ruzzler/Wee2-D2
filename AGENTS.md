...
| **🏗️ Physical** | Chassis, Slip Ring | `3d-print-assembly.md`, `cnbtr-slip-ring-manual.md`, `node-pinout-guide.md` |
...
*   **Sidebar Refinement**: Mantain the "Project Documentation / System Architecture / Microcontroller Nodes / Hardware / Capabilities & Movement / Operation & Maintenance" hierarchy.
...
## 🚫 Avoid These Errors
*   **Don't** use emojis in technical documentation.
*   **Don't** use "cheesy" or "self-important" narrative text.
