...
1. **Rear Logic**: Set as a matrix of **12 Width x 2 Height**. Even though they are physically separated, treating them as one 12x2 strip in WLED allows animations to flow across both windows.
