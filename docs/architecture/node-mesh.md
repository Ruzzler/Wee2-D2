...
The Wee2-D2 utilizing a distributed MCU architecture called the **Node Mesh**. This design handles high-amperage motor control, precision dome rotation, and cinematic AV triggers while minimizing physical wiring through the central slip ring.
...
3. **Firmware Strategy**: Nodes 1 and 3 utilize the `esp-idf` framework within ESPHome for high-stability wireless threading.
