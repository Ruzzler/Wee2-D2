...
Safety and preventative maintenance are the foundations of a mission-ready Imperial droid. These protocols protect your hardware and anyone in the droid's immediate vicinity.
...
*   **LVC Mode**: The **MgcSTEM LVP-R1.5** Low-Voltage Cutoff is your primary line of defense. Ensure it is set to **1.6V/Cell** (16V total) to prevent permanent battery damage.
