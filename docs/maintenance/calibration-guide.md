...
1. Test by triggering a sound on Node 1; the dome should instantly turn red via the **System Bus (UDNS)**.
...
1. **Wait 10 Seconds** for the **System Bus (UDNS)** to initialize and the **System Status LED** (GPIO 2) to start blinking.
