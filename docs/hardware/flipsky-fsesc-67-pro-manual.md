...
> **TECHNICAL SPECIFICATIONS** | **VESC Firmware** | **Mini FSESC 6.7 Pro**
...
1. **Motor Detection**: Run the "Motor Setup Wizard" to calibrate the Hub Motors.
1. **Input Setup**: Use the "Input Wizard" to map your RC Receiver channels.
1. **Limits**:
