...
*   **Physical Topology**:
    ...
    2.  **Inner Ring 1**: LEDs **D25 - D44**.
    3.  **Inner Ring 2**: LEDs **D45 - D60**.
    4.  **Core / Matrix**: LEDs **D61 - D76** (Central logic cluster).

## 🛠️ WLED Configuration Guide

To get the most authentic "Astromech PSI" look in **WLED**, use the following settings for **Node 2: Dome Lights**:
