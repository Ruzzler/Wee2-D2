...
## 🚀 Project Overview
Wee2-D2 uses a decentralized architecture across three ESP32 microcontrollers to ensure non-blocking operation of audio, lighting, and mechanical systems. The droid is controlled via physical RC signals and hardwired logic for maximum reliability during events.
...
*   **Operations**: See the [Maintenance & Operations Guide](./docs/electrical/maintenance-guide.md).
...
├── wiki/               # Droid Databank (Local Technical Wiki)
└── README.md           # This file
```
...
*   **Control**: [HOTRC DS-600](./docs/electrical/hotrc-ds600-manual.md) (Silent Mode mod).
...
## 🏛️ Droid Databank (Wiki)
A Star Wars-themed technical wiki is included in this repository. To view the documented system with a premium "Imperial Databank" interface:
1.  Open a terminal in the project root.
2.  Run the local server: `python -m http.server 8001`
3.  Navigate to [http://localhost:8001/wiki/index.html](http://localhost:8001/wiki/index.html).
